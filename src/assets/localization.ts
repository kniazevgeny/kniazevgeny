export const messages = {
  ru: {
    ...
    home: {
      ...
      myStory: [
        'Привет! Меня зовут Женя и мне интересно делать продукты. Отчасти я программист, отчасти аналитик. Учусь на втором курсе экономического факультета <img style="height: 17px; margin-bottom: -2px" src="' + require("@/assets/polytech.svg") + '"/> Политеха им. Петра (бизнес-информатика)',
  ...
  en: {
    ...
    home: {
      ...
      myStory: [
        'Hi! My name is Evgeny and I\'m interested in making products. I\'m a half developer, half analyst.I\'m studying on the second grade of economic faculty of <img style="height: 17px; margin-bottom: -2px" src="' + require("@/assets/polytech.svg") + '"/> Saint-Petersburg Peter the Great Polytechnical Unviersity (business-informatics)',
