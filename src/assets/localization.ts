export const messages = {
  ru: {
    ...
    home: {
      ...
      myStory: [
        'Привет! Меня зовут Женя и мне интересно делать продукты. Отчасти я программист, отчасти аналитик. Учусь на первом курсе экономического факультета Политеха им. Петра <img style="height: 17px; margin-bottom: -2px" src="' + require("@/assets/polytech.svg") + '"/> (бизнес-информатика)',
