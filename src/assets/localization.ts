    ...
    projects: [
    ...
    },
      {
        ...
        },
        {
          ...
          paragraphs: [
            'Исследовал одну из ЦУР (целей устойчивого развития) в рамках прокета двуязычного отделения в старших классах. Этот проект следовало сдать на французском, когда большая часть материалов на английском, а редактировать я умею преимущественно на руском. Так я познакомился с переводчиком Deepl',
