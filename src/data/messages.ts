...
const asset = (name: string) => {
  const value = assetModules['../assets/' + name]
    ...
    projects: [
      {
        ...
        projects: [
          {
            title: 'LiP Drug Discovery Platform',
            summary:
              'Единое рабочее пространство для проектов по поиску лекарственных кандидатов.',
            type: 'Drug discovery platform',
            id: 'lip',
            artwork: 'logo',
            slides: [asset('lip-1-m.png')],
            paragraphs: [
              'Платформа объединяет целевые биомолекулы, коллекции молекул, гипотезы и вычислительные задачи в одном интерфейсе.',
              'Реализовал full-stack продукт на React, TypeScript, Ant Design, FastAPI, PostgreSQL и RDKit, включая 2D/3D-визуализацию молекул, генерацию кандидатов и планирование синтеза.',
            ],
          },
          {
            title: 'Whimbean',
            summary:
              'Поиск мест по атмосфере: исследуйте город по настроению, а не по категориям.',
            type: 'AI place discovery',
            id: 'whimbean',
            link: 'https://whimbean.com/',
            artwork: 'logo',
            slides: [asset('whimbean-1-m.png')],
            paragraphs: [
              'Whimbean анализирует фотографии и отзывы, чтобы показать характер мест и подобрать варианты под выбранный вайб.',
              'Создал интерактивный интерфейс карты, естественно-языковой поиск, фильтры настроения и семантический discovery на основе векторного поиска.',
            ],
          },
        ],
      },
        ...
        projects: [
          {
            ...
            slides: [asset('easytix-1-m.webp')],
            lazySlides: [asset('easytix-1-l.webp')],
            paragraphs: [
          ...
          },
          {
            ...
            id: 'munk',
            link: 'https://munk.ru/',
            slides: [asset('munk-1-m.webp')],
            lazySlides: [asset('munk-1-l.webp')],
            paragraphs: [
          ...
          },
          {
            ...
            slides: [asset('peerhub-1-m.png')],
            lazySlides: [asset('thepakt-1-l.png')],
            paragraphs: [
      ...
      },
      {
        ...
        projects: [
          ...
          },
          {
            ...
            slides: [
              asset('soulbody-1-m.webp'),
              asset('soulbody-2-m.webp'),
              asset('soulbody-3-m.webp'),
              asset('soulbody-4-m.webp'),
              asset('soulbody-5-m.webp'),
            ],
            lazySlides: [
              asset('soulbody-1-l.webp'),
              asset('soulbody-2-l.webp'),
              asset('soulbody-3-l.webp'),
              asset('soulbody-4-l.webp'),
              asset('soulbody-5-l.webp'),
            ],
            paragraphs: [
        ...
        projects: [
          {
            ...
            slides: [
              asset('smltplus-1-m.webp'),
              asset('smltplus-2-m.webp'),
              asset('smltplus-3-m.webp'),
              asset('smltplus-4-m.webp'),
            ],
            lazySlides: [
              asset('smltplus-1-l.webp'),
              asset('smltplus-2-l.webp'),
              asset('smltplus-3-l.webp'),
              asset('smltplus-4-l.webp'),
            ],
            paragraphs: [
          ...
          },
          {
            ...
            hasDemo: true,
            slides: [asset('bspb-1-m.webp'), asset('bspb-2-m.webp')],
            lazySlides: [asset('bspb-1-l.webp'), asset('bspb-2-l.webp')],
            paragraphs: [
        ...
        projects: [
          {
            ...
            slides: [
              asset('ivankovlab-1-m.webp'),
              asset('ivankovlab-2-m.webp'),
              asset('ivankovlab-3-m.webp'),
              asset('ivankovlab-4-m.webp'),
            ],
            lazySlides: [
              asset('ivankovlab-1-l.webp'),
              asset('ivankovlab-2-l.webp'),
              asset('ivankovlab-3-l.webp'),
              asset('ivankovlab-4-l.webp'),
            ],
            paragraphs: [
          ...
          //   slides: [
          //     asset("echarge-1-m.webp"),
          //     asset("echarge-2-m.webp"),
          //     asset("echarge-3-m.webp"),
          //     asset("echarge-4-m.webp"),
          //   ],
          //   lazySlides: [
          //     asset("echarge-1-l.webp"),
          //     asset("echarge-2-l.webp"),
          //     asset("echarge-3-l.webp"),
          //     asset("echarge-4-l.webp"),
          //   ],
          //   paragraphs: [
          ...
          // },
          {
            ...
            slides: [
              asset('mckinsey-1-m.webp'),
              asset('mckinsey-2-m.webp'),
              asset('mckinsey-3-m.webp'),
              asset('mckinsey-4-m.webp'),
            ],
            lazySlides: [
              asset('mckinsey-1-l.webp'),
              asset('mckinsey-2-l.webp'),
              asset('mckinsey-3-l.webp'),
              asset('mckinsey-4-l.webp'),
            ],
            paragraphs: [
      ...
      },
      {
        ...
        projects: [
          ...
          //   slides: [
          //     asset("honestspeculators-1-m.webp"),
          //     asset("honestspeculators-2-m.webp"),
          //     asset("honestspeculators-3-m.webp"),
          //   ],
          //   lazySlides: [
          //     asset("honestspeculators-1-l.webp"),
          //     asset("honestspeculators-2-l.webp"),
          //     asset("honestspeculators-3-l.webp"),
          //   ],
          //   paragraphs: [
          ...
          // },
          {
            ...
            slides: [asset('cybereconomy-1-m.webp')],
            lazySlides: [asset('cybereconomy-1-l.webp')],
            paragraphs: [
          ...
          //   slides: [
          //     asset("matrix-1-m.webp"),
          //     asset("matrix-2-m.webp"),
          //     asset("matrix-3-m.webp"),
          //     asset("matrix-4-m.webp"),
          //     asset("matrix-5-m.webp"),
          //     asset("matrix-6-m.webp"),
          //   ],
          //   lazySlides: [
          //     asset("matrix-1-l.webp"),
          //     asset("matrix-2-l.webp"),
          //     asset("matrix-3-l.webp"),
          //     asset("matrix-4-l.webp"),
          //     asset("matrix-5-l.webp"),
          //     asset("matrix-6-l.webp"),
          //   ],
          //   paragraphs: [
          ...
          // },
          {
            ...
            slides: [asset('russierenouvelables-1-m.webp')],
            lazySlides: [asset('russierenouvelables-1-l.webp')],
            paragraphs: [
      ...
      },
      {
        ...
        projects: [
          ...
          //   slides: [
          //     asset("keyzu-1-m.webp"),
          //     asset("keyzu-2-m.webp"),
          //     asset("keyzu-3-m.webp"),
          //     asset("keyzu-4-m.webp"),
          //   ],
          //   lazySlides: [
          //     asset("keyzu-1-l.webp"),
          //     asset("keyzu-2-l.webp"),
          //     asset("keyzu-3-l.webp"),
          //     asset("keyzu-4-l.webp"),
          //   ],
          //   paragraphs: [
          ...
          // },
          {
            ...
            hasDemo: false,
            slides: [
              asset('znaikrai-1-.webp'),
              asset('znaikrai-2-.webp'),
              asset('znaikrai-3-m.webp'),
              asset('znaikrai-4-m.webp'),
            ],
            lazySlides: [
              asset('znaikrai-1-l.webp'),
              asset('znaikrai-2-l.webp'),
              asset('znaikrai-3-l.webp'),
              asset('znaikrai-4-l.webp'),
            ],
            paragraphs: [
        ...
        projects: [
          {
            ...
            slides: [
              asset('miserables-1-m.webp'),
              asset('miserables-2-m.webp'),
              asset('miserables-3-m.webp'),
              asset('miserables-4-m.webp'),
            ],
            lazySlides: [
              asset('miserables-1-l.webp'),
              asset('miserables-2-l.webp'),
              asset('miserables-3-l.webp'),
              asset('miserables-4-l.webp'),
            ],
            paragraphs: [''],
          },
        ],
        ...
        projects: [
          {
            title: 'LiP Drug Discovery Platform',
            summary:
              'A unified workspace for drug-candidate discovery projects.',
            type: 'Drug discovery platform',
            id: 'lip',
            artwork: 'logo',
            slides: [asset('lip-1-m.png')],
            paragraphs: [
              'The platform brings target biomolecules, molecule collections, hypotheses, and computational jobs into one interface.',
              'Built the full-stack product with React, TypeScript, Ant Design, FastAPI, PostgreSQL, and RDKit, including 2D/3D molecular visualization, candidate generation, and synthesis planning.',
            ],
          },
          {
            title: 'Whimbean',
            summary:
              'Vibe-based place discovery: explore a city by mood, not categories.',
            type: 'AI place discovery',
            id: 'whimbean',
            link: 'https://whimbean.com/',
            artwork: 'logo',
            slides: [asset('whimbean-1-m.png')],
            paragraphs: [
              'Whimbean analyzes photos and reviews to map the character of places and surface spots matching a chosen vibe.',
              'Built the interactive map interface, natural-language search, mood filters, and semantic discovery backed by vector search.',
            ],
          },
        ],
      },
